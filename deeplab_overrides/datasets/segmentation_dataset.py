...
from deeplab.datasets import segmentation_dataset as _super
...
_ITEMS_TO_DESCRIPTIONS = _super._ITEMS_TO_DESCRIPTIONS

# Named tuple to describe the dataset properties.
DatasetDescriptor = _super.DatasetDescriptor

_CITYSCAPES_INFORMATION = _super._CITYSCAPES_INFORMATION

_PASCAL_VOC_SEG_INFORMATION = _super._PASCAL_VOC_SEG_INFORMATION

# These number (i.e., 'train'/'test') seems to have to be hard coded
# You are required to figure it out for your training/testing example.
_ADE20K_INFORMATION = _super._ADE20K_INFORMATION
